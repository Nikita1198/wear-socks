      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 rtl:space-x-reverse">
          <a href="#" className="hover:opacity-80">
            <img src="/whats.png" className="h-6 w-6" alt="WhatsApp" />
          </a>
          <a href="#" className="hover:opacity-80">
            <img src="/tg.png" className="h-6 w-6" alt="Telegram" />
          </a>
        ...
        <div className={`items-center justify-between w-full md:flex md:w-auto md:order-1 ${isOpen ? 'block' : 'hidden'}`} id="navbar-sticky">
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-black md:space-x-8 lg:space-x-16 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-black dark:bg-black md:dark:bg-black dark:border-gray-700 md:pt-1 md:ml-[-10px] ml-[70px]">
            <li>
